...
import type { EnrollmentRequest as _EnrollmentRequest, Time as _Time } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllEnrollmentRequests(): Promise<Array<EnrollmentRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllEnrollmentRequests();
    ...
    async submitEnrollmentRequest(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitEnrollmentRequest(arg0, arg1, arg2, arg3, to_candid_opt_n5(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_EnrollmentRequest_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _EnrollmentRequest): EnrollmentRequest {
...
function from_candid_vec_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_EnrollmentRequest>): Array<EnrollmentRequest> {
    return value.map((x)=>from_candid_EnrollmentRequest_n2(_uploadFile, _downloadFile, x));
}
